...
const Login = () => {
  ...
  return (
    <>
    <div className="flex items-center justify-between px-6 md:px-[200px] py-4 bg-sky-800">
    <h1 className="text-lg md:text-xl font-extrabold"><Link to="/"><img className="h-24 w-24 rounded-full border border-black" src="\src\images\Logo.png"></img></Link></h1>
    <h3><Link to="/register" className="text-white text-2xl">Register</Link></h3>
    </div>
